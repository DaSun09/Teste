...
UI.innerHTML = `<div id="Launcher" class="Launcher" style="outline: #14bf96 solid 2px; min-height: 250px;opacity: 0.85;font-family: sans-serif;width: 100vw;height: 75px;background: 
black;position: fixed;border-radius: 5px;display: grid;place-items: center;color: white;z-index: 99999;">
